                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-8 w-8">
                      {getProviderLogo(provider.name) ? (
                        <div className="h-8 w-8 rounded-lg overflow-hidden bg-white border border-gray-200 flex items-center justify-center">
                          <Image
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                parent.innerHTML = `<div class="h-8 w-8 rounded-lg bg-gray-100 flex items-center justify-center"><span class="text-xs font-medium text-gray-600">${getProviderInitial(provider.name)}</span></div>`;
                              }
                            }}
                          />
                        </div>
