    ...
    <div className="bg-white">
      ...
      <main>
        ...
        <div id="information" className="mb-8">
          ...
          {(hasValidBenchmarkData(model.codeLMArena) || hasValidBenchmarkData(model.mathLiveBench) || hasValidBenchmarkData(model.codeLiveBench) || hasValidBenchmarkData(model.codeRankedAGI) || hasValidBenchmarkData(model.aime2024) || hasValidBenchmarkData(model.humanEval) || hasValidBenchmarkData(model.math) || hasValidBenchmarkData(model.mmlu) || hasValidBenchmarkData(model.mmluPro)) && (
            <div id="benchmarks" className="mt-10 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {/* AIME 2024 */}
                {hasValidBenchmarkData(model.aime2024) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      <div className="p-1.5 bg-gray-50 rounded">
                        <div className="h-3 w-3 text-gray-700 font-bold flex items-center justify-center text-sm">∑</div>
                      </div>
                      <BenchmarkTooltip
                        title="AIME 2024"
                        description="American Invitational Mathematics Examination 2024 – olympiad-level math reasoning across algebra, geometry, combinatorics, and number theory."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">AIME 2024</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">Math reasoning</p>
                      <div className="text-xl font-bold text-gray-900">{model.aime2024}</div>
                    </div>
                  </div>
                )}

                {/* GPQA */}
                {hasValidBenchmarkData(model.gpqa) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      <div className="p-1.5 bg-gray-50 rounded">
                        <div className="h-3 w-3 text-gray-700 font-bold flex items-center justify-center text-sm">Φ</div>
                      </div>
                      <BenchmarkTooltip
                        title="GPQA"
                        description="Graduate-level multiple-choice questions across science domains; Google-proof and extremely challenging."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">GPQA</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">Science knowledge</p>
                      <div className="text-xl font-bold text-gray-900">{model.gpqa}</div>
                    </div>
                  </div>
                )}
                {/* CodeLMArena */}
                ...
                {/* HumanEval */}
                {hasValidBenchmarkData(model.humanEval) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      <BenchmarkTooltip
                        title="HumanEval"
                        description="Functional correctness on code generation from docstrings across 164 tasks."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">HumanEval</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">Coding correctness</p>
                      <div className="text-xl font-bold text-gray-900">{model.humanEval}</div>
                    </div>
                  </div>
                )}

                {/* MATH */}
                {hasValidBenchmarkData(model.math) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      <div className="p-1.5 bg-purple-50 rounded">
                        <div className="h-3 w-3 text-purple-600 font-bold flex items-center justify-center text-sm">√</div>
                      ...
                      <BenchmarkTooltip
                        title="MATH"
                        description="High-school level mathematics benchmark assessing problem solving across 12 categories."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">MATH</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">Math problem solving</p>
                      <div className="text-xl font-bold text-gray-900">{model.math}</div>
                    </div>
                  </div>
                )}

                {/* MMLU */}
                {hasValidBenchmarkData(model.mmlu) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      <div className="p-1.5 bg-pink-50 rounded">
                        <div className="h-3 w-3 text-pink-600 font-bold flex items-center justify-center text-sm">Ω</div>
                      </div>
                      <BenchmarkTooltip
                        title="MMLU"
                        description="Knowledge across 57 subjects spanning STEM, humanities, and professional domains."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">MMLU</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">General knowledge</p>
                      <div className="text-xl font-bold text-gray-900">{model.mmlu}</div>
                    </div>
                  </div>
                )}

                {/* MMLU-Pro */}
                {hasValidBenchmarkData(model.mmluPro) && (
                  <div className="bg-white border border-gray-100 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-3">
                      <div className="p-1.5 bg-red-50 rounded">
                        <div className="h-3 w-3 text-red-600 font-bold flex items-center justify-center text-sm">9</div>
                      </div>
                      <BenchmarkTooltip
                        title="MMLU-Pro"
                        description="Harder variant of MMLU with more reasoning-intensive questions and expanded options."
                      >
                        <h3 className="text-sm font-semibold text-gray-900 cursor-help">MMLU-Pro</h3>
                      </BenchmarkTooltip>
                    </div>
                    <div className="mb-1">
                      <p className="text-xs text-gray-500 mb-1">Advanced knowledge</p>
                      <div className="text-xl font-bold text-gray-900">{model.mmluPro}</div>
                    </div>
                  </div>
                )}
              </div>
